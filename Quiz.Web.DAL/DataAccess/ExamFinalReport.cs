...
namespace Quiz.Web.DAL.DataAccess
{
    ...
    public partial class ExamFinalReport
    {
        ...
        public Nullable<bool> IsStrongConsider { get; set; }
        public Nullable<bool> IsMayConsider { get; set; }
        public Nullable<bool> IsNotConsider { get; set; }
